...
#     return (False, [], 1, 0, 0, False, False) #return (False, [], 0, 0, 0, False, False)
...
# # Update level display with current level
...
#     if lv_started and not searched and game_utils.has_selected_algorithm() and not game_popup.visible:
#         cars = []
